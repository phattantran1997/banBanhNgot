      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="beta-products-list">
            ...
            <div class="beta-products-details">
              <p class="pull-left">Tìm thấy {{count($km_product)}}</p>
              <div class="clearfix"></div>
            </div>
            <div class="row">
              @foreach($km_product as $km)
              <div class="col-sm-3">
                <div class="single-item">
                  <div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>
                  ...
                  <div class="single-item-body">
                    ...
                    <p class="single-item-price">
                      <span class="flash-del">{{$km->unit_price}}</span>
                      <span class="flash-sale">{{$km->promotion_price}}</span>
                    </p>
                  </div>
                  <div class="single-item-caption">
                    <a class="add-to-cart pull-left" href="{{route('themgiohang',$new->id)}}"><i class="fa fa-shopping-cart"></i></a>
                    <a class="beta-btn primary" href="{{route('chitietsanpham',$km->id)}}">Details <i class="fa fa-chevron-right"></i></a>
                    <div class="clearfix"></div>
                  </div>
                </div>
              </div>
